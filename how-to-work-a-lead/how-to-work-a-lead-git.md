The lead detail panel is where you do the day-to-day work of moving a single lead through your sales process in Franchise Systems Ai (FS Ai).

It gives you their contact details, a message thread, tasks, a full activity history, and their documents in one panel, without leaving your pipeline.

### Opening the lead panel

Go to **Sales → Pipeline** and click any lead in the table. Their detail panel slides in from the right with the lead's name, current status, brand, and location at the top.
...
- **Date Joined**: when the lead entered your pipeline.
- **Contact Information**: first name, last name, email, and phone.
...
You can attach files, add emoji, and record voice messages using the icons in the composer.
...
Use **Log Activity** to add a note recording a call or a next step.
...
The **...** menu in the top right of the panel gathers the actions you take on a lead, including sending a portal invite, sending an email, sending an FDD for signature, converting the lead to a franchisee, locking or unlocking the portal, and downloading a PDF of the lead's profile.

The pin icon keeps the lead in your saved tabs, and the link icon copies a direct link you can share with a teammate.

![](https://raw.githubusercontent.com/maxmaeser/helpdesk-screenshots/master/how-to-work-a-lead/lead-actions-menu.png)
