...
![getting-started-with-franchise-systems-ai opener](https://raw.githubusercontent.com/maxmaeser/helpdesk-screenshots/master/getting-started-with-franchise-systems-ai/getting-started-with-franchise-systems-ai-opener-v2.png)
### How the platform is structured

FS Ai is organized into three levels:

1. **Organization**: the top-level account that holds your brands, team members, and billing.
2. **Brand**: each franchise concept you manage. Brands have their own sales pipelines, marketing audiences, operations data, and portal configurations.
3. **Agent**: any user who logs into the brand dashboard. Agents belong to an organization and can access one or more brands within it.

### What you can do from the dashboard

The brand dashboard is divided into several areas, accessible from the left sidebar:

- **Home**: your overview, calendar, tasks, and chat.
- **Marketing**: manage audiences, social posts, lead finding, and automated marketing workflows.
- **Sales**: work your pipeline, define territories, run workflows, view analytics, and manage sales assets.
- **Operations**: manage franchisee audiences, locations, vendors, operational workflows, catalog items, manuals, courses, and support tickets.
- **Projects**: track and manage internal projects.
- **Brand**: view and edit your brand identity and overview.
