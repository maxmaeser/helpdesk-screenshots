...
![Deploy menu in the email builder with Send as Newsletter selected](https://raw.githubusercontent.com/maxmaeser/helpdesk-screenshots/master/how-to-send-email/send-email-deploy-button.png)
...
![Deploy Newsletter drawer on the Configure step, asking who should receive this, with the audience segment picker](https://raw.githubusercontent.com/maxmaeser/helpdesk-screenshots/master/how-to-send-email/send-email-configure-step.png)

4. On **Purpose**, choose the sending purpose. This is what decides which of your verified domains can carry the send.

![Deploy Newsletter drawer on the Purpose step, asking what the purpose of this send is](https://raw.githubusercontent.com/maxmaeser/helpdesk-screenshots/master/how-to-send-email/send-email-purpose-step.png)
...
![Deploy Newsletter drawer on the Schedule step, with the sending window, timezone, domain picker and the daily volume graph](https://raw.githubusercontent.com/maxmaeser/helpdesk-screenshots/master/how-to-send-email/send-email-schedule-step.png)

6. On **Review**, check the summary and click **Send Newsletter**.

![Review step showing the send summary with subject, segment, purpose, schedule and domains, and the Send Newsletter button](https://raw.githubusercontent.com/maxmaeser/helpdesk-screenshots/master/how-to-send-email/send-email-newsletter-schedule.png)
...
![Segments tab under Marketing Audiences with a segment selected and the Send to Segment drawer opening](https://raw.githubusercontent.com/maxmaeser/helpdesk-screenshots/master/how-to-send-email/send-email-segment-send.png)
...
![Send to Segment drawer on the Select step, choosing a campaign, with the five step names across the top](https://raw.githubusercontent.com/maxmaeser/helpdesk-screenshots/master/how-to-send-email/send-email-campaign-select-step.png)
...
![Send to Segment drawer on the Sending step, with the pacing options and the Enroll button showing the contact count](https://raw.githubusercontent.com/maxmaeser/helpdesk-screenshots/master/how-to-send-email/send-email-campaign-sending-step.png)
