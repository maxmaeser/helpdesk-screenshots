...
- **Watch Video**: Embed a video for the applicant to watch
- **Complete Form**: Present a form to collect information
- **View Slides**: Display a slide deck or presentation
- **Slides (FSAI Studio)**: Display a deck you built in Studio Sliders
- **Schedule Call**: Schedule a call through the booking system
- **Sign a Document**: Send a document for electronic signature
- **Visit Link**: Direct the applicant to an external URL
- **Upload Documents**: Request a file upload from the applicant

To add a step, click **Add Step** at the bottom of a section. Select the step type in **Step Action**, fill in the title and description, then configure the action-specific fields.

![The Step Action list open, showing Watch Video, Schedule Call, Sign a Document, Complete Form, View Slides, Visit Link, Upload Documents, and Slides (FSAI Studio)](https://raw.githubusercontent.com/maxmaeser/helpdesk-screenshots/master/how-to-edit-your-portal/portal-add-step-2026-03-13.png)
...
Below the typography settings, select a **Base Theme Color** and a **Secondary Theme Color** from 10 presets: Light, Blue, Burgundy, Cyan, Gold, Green, Orange, Purple, Red, and Yellow. The secondary color controls accents like buttons, icons, and avatars.
