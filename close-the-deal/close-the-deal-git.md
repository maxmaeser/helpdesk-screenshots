This is the stage where a worked lead becomes a signed franchisee in Franchise Systems Ai (FS Ai).

You are here once a lead is qualified and ready to move forward. You need to open a deal, disclose the FDD, collect signatures, and convert them into a franchisee.

Everything below lives on the **Deal** tab of a lead's detail panel, which you reach under **Sales → Pipeline** on the **Leads** tab.

Each deal carries a type, a status, its documents and signatures, and a **Convert To Franchisee** button once it is ready.

![close-the-deal opener](https://raw.githubusercontent.com/maxmaeser/helpdesk-screenshots/master/close-the-deal/close-the-deal-opener-v4.png)
