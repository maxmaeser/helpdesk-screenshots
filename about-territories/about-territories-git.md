...
The **States** tab lists the states where your brand operates or plans to operate, with an interactive map beside the list.

Each state record shows:

- **Status**: Active or Inactive
- **Registration status**: Registered, Filed, Filing Only, Registration Required, Expired, or No Registration
...
- **Country**: Canada, United States, or US Territories
- **Sort**: Active first, Name A-Z, Expiry soonest, or Needs attention
- **Franchising status**: All states, Franchising, or Not franchising
- **Registration status filter**: any combination of the six statuses above
- **FDD coverage**: Any FDD, Has FDD, or No FDD

States that need attention, the ones the Needs attention sort brings to the top, are highlighted in orange on the map with a warning marker. Hover the marker for details.
